...
/**
 * @extends ServiceEntityRepository<Bras>
 *
...
class BrasRepository extends ServiceEntityRepository
{
    ...
    public function save(Bras $entity, bool $flush = false): void
    {
    ...
    public function remove(Bras $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Bras[] Returns an array of Bras objects
//     */
...
//    public function findOneBySomeField($value): ?Bras
//    {
//        return $this->createQueryBuilder('b')
//            ->andWhere('b.exampleField = :val')
//            ->setParameter('val', $value)
